...
export default function App(){
  ...
  <div className="bg-[#F9F9F9] w-full min-h-screen flex flex-col items-center">
    ...
    <ul className="flex flex-row items-center space-x-4">
      ...
      <button className="ml-4 md:ml-10 px-4 py-1 bg-[#FF8533] rounded-full text-[#F9F9F9] hover:bg-[#020340] transition-colors duration-400">
      Join for free
      </button>
    </ul>
    </nav>
    ...
    <div className="p-1 flex flex-col items-center w-full max-w-[848px] mx-auto">
      <h1 className="p-2 flex justify-center text-[32px] md:text-[48px] w-full text-center text-[#020340]">
