    ...
    <div className="bg-[#F9F9F9] w-full min-h-screen flex flex-col items-center">
      ...
      <section id="about" className="max-w-7xl w-full mx-auto px-4 mt-10 md:mt-20">
        <div className="flex flex md:flex-row mt-10 md:mt-20 w-full max-w-7xl px-0 md:px-4">
          <img
            className="p-2  w-[150px] h-[100px] md:max-w-[484px] rounded-lg h-auto md:h-[579px] object-cover mx-auto"
            src={group}
            alt=""
          />
          ...
          <div className="text-center flex flex-col p-4 md:m-20 md:mr-24 self-center w-full">
            ...
            >
              {services.map((service, i) => (
                <div className={`flex self-space-around p-4 w-[367px]  bg-white rounded-lg shadow-md items-start hover:${service.color}`} key={i}>
                  ...
                  <span className="flex flex-col items-start w-full">
                    <h1 className="font-bold text-[20px] text-[#020340] mb-1">{service.title}</h1>
                    <p className="text-start text-[16px] text-[#020340]">
                      {service.description}
                    </p>
                  </span>
                </div>
